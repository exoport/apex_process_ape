...
- [step-completion-gates.md](step-completion-gates.md) — why a `Stop` hook alone is not proof a step finished, and the four gates that decide completion since v0.0.52.
