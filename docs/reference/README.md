...
- [cli.md](cli.md) — every command, flag, and default (generated from the command tree; run `make docs-cli` to regenerate, and `make docs-cli-check` — which GitHub CI also runs — to verify it is in sync).
