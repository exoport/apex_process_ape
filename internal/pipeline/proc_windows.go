...
// child but leaves any grandchildren orphaned. claude's own subprocess
// model on Windows currently spawns direct children only, so the
// observed orphan-subagent gap on Unix doesn't reproduce here.
func configureProcessGroup(_ *exec.Cmd) {}

func finalProcessGroupCleanup(_ *exec.Cmd) {}
